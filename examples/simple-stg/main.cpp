...
void init(IGraphicsProvider& g) {
	testModel = g.LoadModel("assets/testcube.glb");
	gunModel = g.LoadModel("assets/gun.glb");
	beamModel = g.LoadModel("assets/beam.glb");
	tgtModel = g.LoadModel("assets/target.glb");
	gamestartModel = g.LoadModel("assets/GameStart.glb");
	gamestartSelectedModel = g.LoadModel("assets/GameStart_selected.glb");
	timeModel = g.LoadModel("assets/time.glb");
	scoreStrModel = g.LoadModel("assets/score.glb");
	sphereModel = g.LoadModel("assets/sphere.glb");
	scoreModel[0] = g.LoadModel("assets/score100.glb");
	scoreModel[1] = g.LoadModel("assets/score50.glb");
	...
	alManager.emplace();
	gunSe.emplace("assets/gun.wav");
	tgtSe.emplace("assets/target.wav");
	buzzerSe.emplace("assets/buzzer.wav");
	cntSe.emplace("assets/pi.wav");
